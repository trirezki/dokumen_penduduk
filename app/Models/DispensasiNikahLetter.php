...
class DispensasiNikahLetter extends Model
{
    use HasFactory;

    public static $must_verification = true;
    public static $type = "DISPENSASI_NIKAH";
    ...
    public function pemohon_laki_laki()
    {
        return $this->belongsTo(Resident::class, 'pemohon_laki_laki_id', 'id');
    }

    public function pemohon_perempuan()
    {
        return $this->belongsTo(Resident::class, 'pemohon_perempuan_id', 'id');
    }
