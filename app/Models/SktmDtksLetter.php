...
class SktmDtksLetter extends Model
{
    use HasFactory;

    public static $must_verification = true;
    public static $type = "SKTM_DTKS";
    ...
    public function resident_sktm_dtks_letters()
    {
        return $this->hasMany(ResidentSktmDtksLetter::class);
    }
